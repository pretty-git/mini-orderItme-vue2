...
/* 26 */
/*!*********************************************************************!*\
  !*** /Users/pretty/Documents/uniapp/mini-orderItme-vue2/pages.json ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!***********************************************************************************!*\
  !*** /Users/pretty/Documents/uniapp/mini-orderItme-vue2/uni.promisify.adaptor.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 45 */
/*!***********************************************************************************!*\
  !*** /Users/pretty/Documents/uniapp/mini-orderItme-vue2/components/utils/date.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 46 */
/*!**************************************************************************************************************!*\
  !*** /Users/pretty/Documents/uniapp/mini-orderItme-vue2/components/pretty-times/composables/useTimeLogic.js ***!
  \**************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.useTimeLogic = useTimeLogic;
var _slicedToArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ 5));
var _defineProperty2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11));
 ...
 * 时间处理逻辑 composable
 */
function useTimeLogic() {
  /**
   * 初始化时间数组
   */
  function initTimeArray(beginTime, endTime, timeInterval, isQuantum) {
    return (0, _date.initTime)(beginTime, endTime, timeInterval, isQuantum);
  }

  /**
   * 处理时间段模式的禁用逻辑
   */
  function processQuantumDisable(timeArr, selectDate, nowDate, disableTimeSlot, orderTimeArr) {
    var timeArrCopy = timeArr.map(function (item) {
      return _objectSpread({}, item);
    });
    timeArrCopy.forEach(function (item) {
      var cur_be_time = "".concat(selectDate, " ").concat(item.begin, ":00");
      var cur_end_time = "".concat(selectDate, " ").concat(item.end, ":00");

      // 检查是否在禁用时间段内
      var _iterator = _createForOfIteratorHelper(disableTimeSlot),
        _step;
      try {
      ...
      if (selectDate === nowDate && (0, _date.currentTime)().time > "".concat(item.begin, ":00")) {
        item.disable = true;
      }

      // 多选时间段的切换日期不清除
      if (orderTimeArr[selectDate]) {
        var _iterator2 = _createForOfIteratorHelper(orderTimeArr[selectDate]),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var _items$, _items$2;
            var items = _step2.value;
            if (((_items$ = items[0]) === null || _items$ === void 0 ? void 0 : _items$.split(" ")[1]) === "".concat(item.begin, ":00") && ((_items$2 = items[1]) === null || _items$2 === void 0 ? void 0 : _items$2.split(" ")[1]) === "".concat(item.end, ":00")) {
              item.isActive = true;
              break;
            }
          }
   ...
   * 处理普通时间模式的禁用逻辑
   */
  function processNormalDisable(timeArr, selectDate, nowDate, appointTime, disableTimeSlot, isSection, isMultiple, orderTimeArr) {
    var timeArrCopy = timeArr.map(function (item) {
      return _objectSpread({}, item);
    });
    var isFullTime = true;
    timeArrCopy.forEach(function (item) {
      var _orderTimeArr$selectD;
      // 判断是当前这一天，选中时间小于当前时间则禁用
      if (selectDate === nowDate && (0, _date.currentTime)().time > item.time) {
        item.disable = true;
      }

      // 将预约的时间禁用
      if (Array.isArray(appointTime)) {
        appointTime.forEach(function (t) {
      ...
      // 禁用时间段
      var cur_time = "".concat(selectDate, " ").concat(item.time);
      if (Array.isArray(disableTimeSlot)) {
        var _iterator3 = _createForOfIteratorHelper(disableTimeSlot),
          _step3;
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var time = _step3.value;
            if (Array.isArray(time) && time.length >= 2) {
              var _time2 = (0, _slicedToArray2.default)(time, 2),
                _time2$ = _time2[0],
                begin_time = _time2$ === void 0 ? "" : _time2$,
                _time2$2 = _time2[1],
                end_time = _time2$2 === void 0 ? "" : _time2$2;
      ...
      // 对多选操作的已选时间的回显
      if (isMultiple && (_orderTimeArr$selectD = orderTimeArr[selectDate]) !== null && _orderTimeArr$selectD !== void 0 && _orderTimeArr$selectD.includes(item.time)) {
        item.isActive = true;
      }
    });
    return {
      timeArrCopy: timeArrCopy,
      isFullTime: isFullTime
    };
  }
  return {
    initTimeArray: initTimeArray,
    processQuantumDisable: processQuantumDisable,
    processNormalDisable: processNormalDisable
  };
}
